...
`../reviews/mbirjax_source_reading_2026-08-10.md`.  The measured
base is `../active/multigpu_findings.md`, §1.2, §1.5, §1.6, §1.7,
...
(`../../projector_kernels/fwd_back_findings.md`).  Our sweep now produces the
...
documentation (`../active/docs.md`, "Numbers used, with their
source").  Both are pre-kernel measurements, as the plan's lever table already
notes (`../active/multigpu_plan.md`, the streaming row).  mg10
...
`.._kernel_design.md`, and its position after the
...
`../../projector_kernels/gpu_headroom_findings.md` and
