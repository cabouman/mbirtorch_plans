...
In the mbirjax_plans repo, please read /archive/torch_port/closed/current_plans.md, archive/torch_port/active/multigpu_plan.md, and .claude/lessons.md for context.  
This file is available at https://github.com/gbuzzard/mbirjax_plans/blob/main/archive/torch_port/active/preprocess_sharding_translation_multiaxis.md.
