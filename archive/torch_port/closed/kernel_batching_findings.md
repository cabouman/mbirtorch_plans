...
`kernel_batching_design.md` (checkpoint-1 notes folded
in), `kernel_batching_findings.md` (this document),
`../../../experiments/torch_port/archive/kb_batching/kb1_gautschi.sbatch`,
`../../../experiments/torch_port/archive/kb_batching/kb2_vbsweep.py`,
`../../../experiments/torch_port/archive/kb_batching/kb2_gautschi.sbatch`,
`../../../experiments/torch_port/archive/kb_batching/kb3_gate.py`,
`../../../experiments/torch_port/archive/kb_batching/kb3_gautschi.sbatch`,
`../../../experiments/torch_port/archive/kb_batching/kb4_value_attrib.py`,
`../../../experiments/torch_port/archive/kb_batching/kb4_gautschi.sbatch`.
