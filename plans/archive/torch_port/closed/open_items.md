...
`../active`.  Each item names where it is recorded.  Paths
...
`../active/multigpu_findings.md` §1.12.
...
Recorded at `../active/multigpu_findings.md` §1.10 and
...
obligation) and `../active/multigpu_findings.md` §1.12.
...
Recorded at `../active/multigpu_findings.md` §1.7 and §6.2, and
...
Recorded at `../active/multigpu_findings.md` §1.14.
...
Recorded at `../active/execution_overview.md` §5.3 and §7.
...
Recorded at `../active/execution_overview.md` §5.2.
...
`../active/execution_overview.md` §7.
...
Recorded at `../active/execution_overview.md` §7.
...
Recorded at `../active/floors_refresh_automation.md` and
...
Recorded at `../active/multigpu_findings.md` §1.14 and §1.15.
...
`` carries decisions with revisit triggers rather than
