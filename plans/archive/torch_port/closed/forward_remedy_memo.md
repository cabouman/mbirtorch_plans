...
`../../../experiments/torch_port/rows/mg5_fwd_attrib_h005_20260809_195819.jsonl`
and `../../../experiments/torch_port/rows/mg7_conebatch_h004_20260810_041607.jsonl`.
...
ignores.  The design is recorded in `../phases/phase5_kernel_design.md`
as K5, and the decision that declined it, with its revisit triggers, is in
`kernel_batching_findings.md`.
...
`../../projector_kernels/fwd_back_findings.md` states the measured
...
`../../projector_kernels/fwd_back_findings.md`).
