...
`../active/multigpu_findings.md` §1.19, §1.20, and
§1.21, with run detail in
`../../../experiments/torch_port/mg21_back_attrib.md` and rows in
`../../../experiments/torch_port/rows`.  The code read for this note is
