...
The audit covered `../../../experiments`, the mbirjax_metrics harness, and the
...
`../../../experiments/torch_port/archive/dp_devicepolicy/dp4_flip_gate.py`,
...
`../../../experiments/torch_port/archive/dp_devicepolicy/dp2_ledger_calib.py`,
`../../../experiments/torch_port/archive/dp_devicepolicy/dp2_gautschi.sbatch`.

Staged in mbirjax_plans:
`device_policy_design.md` (both review rulings),
`device_policy_findings.md` (this document),
`../../../experiments/torch_port/archive/dp_devicepolicy/dp3_phase_probe.py`,
`../../../experiments/torch_port/archive/dp_devicepolicy/dp3_gautschi.sbatch`.
