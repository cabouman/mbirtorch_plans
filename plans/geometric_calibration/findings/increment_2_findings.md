...
`calibration_512_gautschi.md` in `plans/geometric_calibration/experiments/`.  From an
...
`plans/geometric_calibration/experiments/`.  `conjugate_offset_recovery.md` sweeps the
...
`estimators_in_action.py` in `plans/geometric_calibration/experiments/` draws four
...
`plans/geometric_calibration/experiments/`: `conjugate_offset_recovery.py` and its
