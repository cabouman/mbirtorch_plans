...
\begin{frame}{Missing features at a glance}
  ...
  \source{\texttt{surveys/leap\_comparison/survey.md}; \texttt{surveys/tigre\_comparison/survey.md}}
\end{frame}
...
\begin{frame}{Geometry calibration: how well it works \hfill \released}
  ...
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{plans/geometric\_calibration/experiments/closed/calibration\_512\_gautschi.md} and \texttt{real\_scan\_leap\_tilt.md}}
\end{frame}
\end{continuation}
...
\begin{frame}{Lower GPU memory: what changed and the result \hfill \released}
  ...
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{plans/device\_memory\_tiers/experiments/dm1\_record.md}}
\end{frame}
\end{continuation}
...
\begin{frame}{A reconstruction returns from the GPUs 24 times faster \hfill \released}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/findings/host\_gather.md};
  \texttt{surveys/leap\_comparison/findings/ornl\_reproduction.md}, Section 3.4}
\end{frame}
...
\begin{frame}{Three features that are complete in code but not released}
  ...
  \begin{itemize}
    ...
    \item \prototype~\textbf{Multi-slice fusion} runs from research scripts in
      mbirtorch's \texttt{experiments/drunet/} and \texttt{mbirtorch\_applications/}.
  ...
  to use it.}
  \source{\texttt{plans/mace4d/plan.md};
  \texttt{plans/multi\_slice\_fusion/plan.md}}
\end{frame}
...
\begin{frame}{A consensus loop that accepts any agent \hfill \onbranch}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{mbirtorch/mace.py} at \texttt{8304b25}; \texttt{plans/mace4d/}}
\end{frame}
...
\begin{frame}{Multi-slice fusion with a network denoiser \hfill \prototype}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{plans/multi\_slice\_fusion/findings/multi\_slice\_fusion\_findings.md};
  \texttt{surveys/leap\_comparison/experiments/ornl/msf\_ornl.md};
  \texttt{surveys/leap\_comparison/findings/ornl\_reproduction.md}, Section 3.1}
\end{frame}
...
\begin{frame}{4D reconstruction of a moving object \hfill \onbranch}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{mbirtorch/mace4d.py} at \texttt{8304b25}; \texttt{plans/mace4d/}}
\end{frame}
...
\begin{frame}{How the gaps were found}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/findings/quality\_results.md}; \texttt{surveys/leap\_comparison/survey.md}}
\end{frame}
...
\begin{frame}{Offset-scan support \hfill \leaprank{1}~\tigrerank{4}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, item 1; \texttt{surveys/tigre\_comparison/survey.md}, item 4}
\end{frame}
...
\begin{frame}{Truncated-object support \hfill \leaprank{1}~\tigrerank{4}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, item 1; \texttt{leapMBIR/utils/Get\_projection\_parameters\_standalone\_fast.py:321}}
\end{frame}
...
\begin{frame}{A low-memory execution mode \hfill \leaprank{2}~\tigrerank{5}}
  ...
  \source{\texttt{surveys/leap\_comparison/findings/ornl\_reproduction.md}; \texttt{plans/device\_memory\_tiers/}}
\end{frame}
...
\begin{frame}{Scatter correction and spectral physics \hfill \leaprank{3, 5}~\tigrerank{6}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, items 3 and 5; \texttt{surveys/tigre\_comparison/survey.md}, item 6}
\end{frame}
...
\begin{frame}{Analytic phantoms and a noise simulator \hfill \leaprank{4}~\tigrerank{7}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, item 4; \texttt{surveys/tigre\_comparison/survey.md}, item 7}
\end{frame}
...
\begin{frame}{Per-view flexible geometry \hfill \leaprank{6}~\tigrerank{3}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, item 6; \texttt{surveys/tigre\_comparison/survey.md}, item 3}
\end{frame}
...
\begin{frame}{Classical algorithms, composable priors, and PICCS \hfill \leaprank{8}~\tigrerank{1, 2}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, item 8; \texttt{surveys/tigre\_comparison/survey.md}, items 1 and 2}
\end{frame}
...
\begin{frame}{The remaining calibration utilities \hfill \leaprank{7}}
  \begin{columns}[T]
    ...
    \end{column}
  \end{columns}
  \source{\texttt{surveys/leap\_comparison/survey.md}, the calibration table and item 7;
  \texttt{plans/geometric\_calibration/plan.md}}
\end{frame}
...
\begin{frame}{Four smaller gaps \hfill \leaprank{9, 10}~\tigrerank{8, 9}}
  ...
  \end{tabular}}
  \source{\texttt{surveys/leap\_comparison/survey.md}, items 9 and 10; \texttt{surveys/tigre\_comparison/survey.md}, items 8 and 9}
\end{frame}
...
\begin{frame}{Summary}
  ...
  \end{enumerate}}
  \source{\texttt{surveys/leap\_comparison/survey.md};
  \texttt{surveys/tigre\_comparison/survey.md}}
\end{frame}
