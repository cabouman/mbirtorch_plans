...
**Exception:** Small, self-contained experiment files in designated directories (the `experiments/` folder of a plan or survey, e.g., `plans/<task>/experiments/`) may be created when you have been explicitly asked to proceed. Mention the creation and its purpose.
